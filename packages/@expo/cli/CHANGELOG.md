...
- Run prebuild only for the platforms specified in app.json. ([#31752](https://github.com/expo/expo/pull/31752) by [@prathameshmm02](https://github.com/prathameshmm02))
